...
// Validate ../../src/app/(dashboard)/points/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/points">> = Specific
  const handler = {} as typeof import("../../src/app/(dashboard)/points/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../src/app/api/products/upload/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/products/upload">> = Specific
  const handler = {} as typeof import("../../src/app/api/products/upload/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
