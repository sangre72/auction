...
import { boardsApi, postsApi, type BoardListItem, type Post, type PostUpdate } from '@/lib/api';
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
        ...
        <span>/</span>
        <Link href={`/boards/${boardSlug}/${postId}`} className="hover:text-purple-600 truncate max-w-xs">
          {post.title}
        </Link>
        <span>/</span>
        <span>수정</span>
